...
<body class="back-color">
				...
				<div class="col-12">
					<nav class=" navbar navbar-expand-lg navbar-light back-color">
						<div class="back-color container-fluid p-0">
							...
							<h2>ROTC Student Registration</h2>
							<ul class="navbar-nav">
								<li>
	...
	<div class="container mb-5 min-width">
		<form id="rotc-sign-up-form" action="query.php" method="post" novalidate>
                ...
                <div class="control">
                  ...
                  <div class="error-container fs-6 text-danger" style="font-size: 12px !important;">
					...
					<div class="card-footer d-flex justify-content-end">
						<div class="row">
							<div class="col-12">
								<button type="submit" name="rotc-sign-up" class="btn btn-primary" value="Submit">Submit</button>
