...
if (!isset($_SESSION['nstp_component']) || ($_SESSION['nstp_component'] !== "CWTS")) {
  header('Location: http://localhost/CLRMS/login-page.php');
  exit();
}
...
if (isset($_SESSION['username'])) {
  try {
    ...
    $sql = "SELECT * FROM `tbl_20_columns_cwts` WHERE `username` = :username";
