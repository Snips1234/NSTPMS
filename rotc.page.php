...
if (!isset($_SESSION['nstp_component']) && ($_SESSION['nstp_component'] !== "ROTC")) {
...
if (isset($_SESSION['username'])) {
	try {
		...
		$sql = "SELECT * FROM `tbl_20_columns_rotc` WHERE `username` = :username";
				...
				<div class="card-body p-5">
					<div class="d-flex flex-column">
						<div class="nav flex-row justify-content-center nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							...
							<!-- <button class="nav-link" id="v-pills-logout-tab" data-bs-toggle="pill" data-bs-target="#v-pills-logout" type="button" role="tab" aria-controls="v-pills-logout" aria-selected="false"><i class="fa fa-cog me-2" aria-hidden="true"></i>Logout</button> -->
								...
								<div class=" table-responsive">
									<table class="table m-0 table-striped">
										...
										<tbody>
											...
											<tr>
												<td class="no-wrap fs-6"><b>Gender</b></td>
								...
								<div class="table-responsive">
									<table class="table m-0 table-striped ">
										...
										<tbody>
											...
											<tr>
												<td class="no-wrap fs-6"><b>Region</b></td>
												<td class=" no-wrap fs-6"><?= htmlspecialchars($data['region']) ?></td>
											</tr>
										</tbody>
									</table>
								</div>
                      ...
                      <tr>
                        ...
                        <td class=" no-wrap fs-6"><?= htmlspecialchars($data['major']) ?></td>
							...
							<div class="tab-pane fade" id="v-pills-grade" role="tabpanel" aria-labelledby="v-pills-grade-tab" tabindex="0">
								<div class="table-responsive">
									<table class="table m-0 table-striped ">
										...
										<tbody>
											<tr>
												<td class="no-wrap fs-6"><b>1st Semester</b></td>
												<td class=" no-wrap fs-6"><?= htmlspecialchars($data['grade_sem_1']) ?></td>
											</tr>
											<tr>
												<td class="no-wrap fs-6"><b>2nd Semester</b></td>
												<td class=" no-wrap fs-6"><?= htmlspecialchars($data['grade_sem_1']) ?></td>
											</tr>
											<tr>
												<td class="no-wrap fs-6"><b>Remarks</b></td>
												<td class="no-wrap fs-6"><?= htmlspecialchars(ucwords($data['remarks'])) ?></td>
											</tr>
							...
							<div class="tab-pane fade d-flex justify-content-center" id="v-pills-logout" role="tabpanel" aria-labelledby="v-pills-logout-tab" tabindex="0">
