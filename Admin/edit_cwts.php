...
if (isset($_GET['std_id'])) {
	...
	try {
		...
		$query = "SELECT l_name, f_name, ex_name, m_name, HEI_name, type_of_HEI, b_date, sex, st_brgy, municipality, province,
                c_status, religion, region, email_add, cp_number, college, y_level, course, major, 
                serial_number, cpce, cpce_cp_number, nstp_component, nstp_grad_year, created_at
                FROM tbl_20_columns_cwts WHERE std_id = :id";
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="lts.php">CWTS</a></li>
						...
						<form id="admin-edit-form" action="../query.php" method="post" novalidate>
							...
							<div class="card">
								<div class="card-header bg-success">
									<h4 class="text-white">Update cwts student data</h4>
								</div>
								<div class="card-body">
									<fieldset>
                          ...
                          <div class="error-container fs-6 text-danger" style="font-size: 12px !important;">
                            ...
                            <?php endif; ?>
									...
									<div class="card-footer d-flex justify-content-end">
										<div class="row">
											<div class="col-12">
												<button type="submit" name="admin-edit-cwts" class="btn btn-success" value="Submit">Submit</button>
