...
try {
	...
	$countQuery = "SELECT COUNT(*) as total FROM tbl_20_columns_lts";
	if ($search) {
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item">LTS</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<h3 class="card-title">LTS Student List</h3>
								<div class="mt-5 d-flex justify-content-between align-items-center">
									<a href="add_lts.php" class="btn btn-primary" style="width: 160px !important;">
										Registration
									</a>
												...
												<?php foreach ($results as $row): ?>
													<tr>
														...
														<td class="d-flex flex-row">
															<a href="javascript:void(0)" class="btn btn-tool open-view-modal" type="button" data-toggle="modal" data-id="<?php echo htmlspecialchars($row['std_id']) ?>" data-table="tbl_20_columns_lts" data-type="view" data-target="#view_modal">
																<i class="fas fa-eye text-primary"></i>
															</a>
															<a href="edit_lts.php?std_id=<?= htmlspecialchars($row['std_id']) ?>" class="btn btn-tool">
																<i class="fas fa-pen text-success"></i>
															</a>
															<a href="javascript:void(0)" class="btn btn-tool open-delete-modal" type="button" data-toggle="modal" data-id="<?php echo htmlspecialchars($row['std_id']) ?>" data-table="tbl_20_columns_lts" data-target="#delete_modal" data-type="delete">
		...
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-end">
				<form action="../query.php" method="post">
					...
					<button type="submit" class="btn btn-danger" name="admin-delete-lts" id="admin-delete-lts">Confirm</button>
					<button type=" button" class="btn btn-default" data-dismiss="modal">Close</button>
				</form>
			</div>
		</div>
