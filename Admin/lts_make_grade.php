...
try {
	...
	$query = "SELECT std_id, CONCAT_WS(' ', l_name, f_name, ex_name, m_name) as full_name, b_date, sex,st_brgy, municipality, province, c_status, religion, email_add, cp_number, college, y_level, course, major, quarter_1_grade_sem_1, quarter_1_percent_sem_1, quarter_2_grade_sem_1, quarter_2_percent_sem_1, average_sem_1, average_percent_sem_1, remarks_sem_1,school_year_sem_1, quarter_1_grade_sem_2, quarter_1_percent_sem_2, quarter_2_grade_sem_2, quarter_2_percent_sem_2, average_sem_2, average_percent_sem_2, remarks_sem_2,school_year_sem_2, serial_number, cpce, cpce_cp_number, nstp_component, created_at FROM tbl_20_columns_lts WHERE 1=1";
	...
	$countQuery = "SELECT COUNT(*) as total FROM tbl_20_columns_lts WHERE 1=1";
...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h3 class="m-0">LTS Grading sheet</h3>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
						<li class="breadcrumb-item"><a href="lts_grading.php">LTS Grades</a></li>
							...
							<div class="card-body p-0">
								...
								<form action="../query.php" method="post">
									...
									<div class="card-footer d-flex justify-content-end">
										<button type="submit" name="lts-update-grades" class="btn btn-primary my-3" value="Submit">Update grades</button>
									</div>
								</form>
							</div>
						</div>
