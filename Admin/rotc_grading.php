...
try {
	...
	$query = "SELECT std_id, l_name, f_name, ex_name, m_name, b_date, sex, st_brgy, municipality, province, c_status, religion, email_add, cp_number, college, y_level, course, major, quarter_1_grade_sem_1, quarter_1_percent_sem_1, quarter_2_grade_sem_1, quarter_2_percent_sem_1, average_sem_1, average_percent_sem_1, remarks_sem_1,school_year_sem_1, quarter_1_grade_sem_2, quarter_1_percent_sem_2, quarter_2_grade_sem_2, quarter_2_percent_sem_2, average_sem_2, average_percent_sem_2, remarks_sem_2,school_year_sem_2,serial_number,cpce, cpce_cp_number, nstp_component, created_at FROM tbl_20_columns_rotc";

	// Add search condition if providedasdf
	if ($search) {
...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h3 class="m-0">ROTC Grades</h3>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
						<li class="breadcrumb-item">ROTC Grades</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<h3 class="card-title">ROTC Student Grades</h3>
								<div class="mt-5 d-flex justify-content-between align-items-center">
									<div>
										<a href="grade_report.php" class="btn btn-primary" style="width: 160px !important;">
											Report
										</a>
										<a href="rotc_make_grade.php" class="btn btn-primary" style="width: 160px !important;">
											Grading sheet
										</a>
									</div>
									...
									<table class="table m-0 table-bordered">
										<thead>
											<tr>
												...
												<th class="no-wrap f-12 text-center align-middle" colspan="4">Student Name</th>
